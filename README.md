...
4. Python script for using custom attributes: [Custom attributes](<https://github.com/jcordtz/custom-attributes>)
5. A Purview linux script setup for loading metadata: [Load_script](<https://github.com/jcordtz/load_script>)
